...
import bestSellerApi from "../../api/bestSeller.api";
...
const BestSellers = () => {
  ...
  const fetchConfig = async () => {
    try {
      setLoading(true);
      const response = await bestSellerApi.getConfig();
      ...
      console.error("Error fetching best sellers config:", err);
      showToast(err.message || "Failed to load best sellers config", "error");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      await bestSellerApi.updateConfig(payload);
      showToast("Best Sellers config saved successfully", "success");
    } catch (err) {
      console.error("Error saving best sellers config:", err);
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              Configure the best sellers section displayed on the storefront.
            </p>
          </div>
        </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">
                  Toggle whether the Best Sellers section is visible on the
                  storefront.
                </p>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  placeholder="e.g. Take a look at our best selling products..."
                  rows={3}
