          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className={`px-5 py-2.5 rounded-xl font-medium transition-all duration-300 flex items-center gap-2 ${formData.isActive
          ...
          <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-300">
            ...
            <div className="mt-3 h-1.5 w-full bg-gray-200 rounded-full overflow-hidden">
              <div
                ...
                style={{
                  width: `${(analytics?.orderStats?.completedOrders /
                      (analytics?.orderStats?.totalOrders || 1)) *
                    100
                    }%`,
                }}
              ...
              <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <span
                      className={`px-2.5 py-1 rounded-full text-xs font-medium ${formData.isEmailVerified
              ...
              <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={handleStatusToggle}
                      className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors ${formData.isActive ? "bg-emerald-500" : "bg-gray-300"
                        }`}
                    >
                      <span
                        className={`inline-block h-5 w-5 transform rounded-full bg-white shadow-lg transition-transform ${formData.isActive
                            ? "translate-x-6"
                            : "translate-x-1"
                          }`}
                      />
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      className={`px-3 py-1 rounded-full text-sm font-medium ${formData.isEmailVerified
                          ? "bg-emerald-100 text-emerald-700"
              ...
              {activityLog.slice(0, 10).map((activity, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`h-12 w-12 rounded-xl flex items-center justify-center ${activity.action.includes("ACTIVATED")
                          ? "bg-emerald-100"
