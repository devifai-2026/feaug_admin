...
const EditSubcategory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await categoryApi.updateSubCategory(id, formData)

      showToast('Subcategory updated successfully', 'success')
      navigate('/subcategories')
    } catch (err) {
      const errorMessage = err.response?.data?.message || 'Failed to update subcategory'
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Update subcategory details and settings</p>
            </div>
