...
const MainContent = ({ sidebarOpen }) => {
  ...
  const handleSetTarget = async () => {
    try {
      ...
      if (targetAmount) {
        await dashboardApi.setMonthlyTarget({ targetValue: parseFloat(targetAmount) })
          ...
          <div className="rounded-lg bg-white p-6 shadow">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  {monthlyTarget.hasTarget ? 'Current monthly revenue target' : 'No monthly target set'}
                </p>
              </div>
              <button
            ...
            {monthlyTarget.hasTarget ? (
                        ...
                        <div className="border-l-4 border-blue-500 pl-4 py-2">
                          <p className="text-sm text-gray-700">
                            <span className="font-semibold">
                              You earned {formatCurrency(monthlyTarget.todayEarnings)} today
                            </span>
                            , it's {monthlyTarget.increaseFromLastMonth > 0 ? 'higher' : 'lower'} than last
                            month. {monthlyTarget.increaseFromLastMonth > 0 ? 'Keep up your good work!' : 'Keep pushing!'}
                          </p>
                        </div>
                      )}
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">
                      {monthlyTarget.daysElapsed?.total - monthlyTarget.daysElapsed?.remaining} days elapsed
                    </span>
                    <span className="text-gray-600">
              ...
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">No Target Set</h3>
                <p className="text-gray-600 mb-6 max-w-md mx-auto">
                  {targetInsights.recommendation || 'Set a monthly revenue target to track your performance better.'}
                </p>
                <button
                  onClick={handleSetTarget}
        ...
        <div className="mt-6 rounded-lg bg-white p-6 shadow">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
            ...
            <div className="p-4 bg-purple-50 rounded-lg">
              ...
              <p className={`text-xl font-bold ${revenueOverview.summary?.growth > 0 ? 'text-green-600' : 'text-red-600'}`}>
                {revenueOverview.summary?.growth > 0 ? '+' : ''}{revenueOverview.summary?.growth || 0}%
              </p>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-100">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Detailed analytics for user growth and conversion</p>
                  </div>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-purple-50 to-blue-50 text-purple-700">
                    ...
                    {userGrowthProgress.summary.period === '4weeks' ? 'Last 1 Month' :
                      userGrowthProgress.summary.period === '8weeks' ? 'Last 2 Months' :
                        userGrowthProgress.summary.period === '12weeks' ? 'Last 3 Months' : 'Custom Period'}
                  </span>
                </div>
              </div>
                ...
                <div className="relative overflow-hidden bg-gradient-to-br from-white to-purple-50 rounded-xl border border-purple-100 p-5 shadow-sm">
                  ...
                  <div className="relative">
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        <h4 className="text-sm font-semibold text-gray-900">User Acquisition</h4>
                        <p className="text-xs text-gray-500">New registered users</p>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div className="flex justify-between items-center pb-3 border-b border-gray-100">
                        <span className="text-sm text-gray-600">Total New Users</span>
                        <div className="flex items-center">
                          <span className="text-lg font-bold text-gray-900">
                            {userGrowthProgress.summary.totalNewUsers?.toLocaleString("en-IN") || 0}
                          </span>
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Avg. Weekly Users</span>
                        <span className="text-sm font-semibold text-gray-900">
                          {userGrowthProgress.summary.avgWeeklyUsers?.toLocaleString("en-IN") || 0}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Visitor to User Rate</span>
                        <div className="flex items-center">
                          <span className="text-sm font-semibold text-gray-900">
                            {userGrowthProgress.summary.visitorToUserRate?.toFixed(2) || 0}%
                          </span>
                          <div className="ml-2 h-2 w-16 bg-gray-200 rounded-full overflow-hidden">
                            <div
                              className="h-full bg-gradient-to-r from-purple-500 to-blue-500 rounded-full"
                              style={{ width: `${Math.min(userGrowthProgress.summary.visitorToUserRate || 0, 100)}%` }}
                            ></div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="relative overflow-hidden bg-gradient-to-br from-white to-blue-50 rounded-xl border border-blue-100 p-5 shadow-sm">
                  ...
                  <div className="relative">
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        <h4 className="text-sm font-semibold text-gray-900">Visitor Analytics</h4>
                        <p className="text-xs text-gray-500">Traffic & engagement metrics</p>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div className="flex justify-between items-center pb-3 border-b border-gray-100">
                        ...
                        <div className="flex items-center">
                          <span className="text-lg font-bold text-gray-900">
                            {userGrowthProgress.summary.totalVisitors?.toLocaleString("en-IN") || 0}
                          </span>
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Avg. Weekly Visitors</span>
                        <span className="text-sm font-semibold text-gray-900">
                          {userGrowthProgress.summary.avgWeeklyVisitors?.toLocaleString("en-IN") || 0}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center">
                          <span className="text-sm font-semibold text-gray-900">
                            {userGrowthProgress.summary.totalOrders?.toLocaleString("en-IN") || 0}
                          </span>
                          {userGrowthProgress.summary.totalOrders > 0 && (
                            <span className="ml-2 text-xs px-2 py-1 bg-green-100 text-green-700 rounded-full">
                              {((userGrowthProgress.summary.totalOrders / userGrowthProgress.summary.totalVisitors) * 100).toFixed(1)}% conversion
                            </span>
                          )}
                        </div>
                      </div>
                ...
                <div className="relative overflow-hidden bg-gradient-to-br from-white to-emerald-50 rounded-xl border border-emerald-100 p-5 shadow-sm">
                  ...
                  <div className="relative">
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        <h4 className="text-sm font-semibold text-gray-900">Recent Week Performance</h4>
                        <p className="text-xs text-gray-500">Latest weekly snapshot</p>
                      </div>
                    </div>
                    {userGrowthProgress.summary.mostRecentWeek ? (
                      <div className="space-y-4">
                        <div className="pb-3 border-b border-gray-100">
                          <p className="text-xs font-medium text-gray-500 mb-1">Week of</p>
                          <p className="text-sm font-semibold text-gray-900 flex items-center">
                            {userGrowthProgress.summary.mostRecentWeek.label || 'Last Week'}
                            {userGrowthProgress.summary.mostRecentWeek.newUsers > 0 && (
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          <div className="text-center">
                            <div className="text-lg font-bold text-gray-900">
                              {userGrowthProgress.summary.mostRecentWeek.visitors?.toLocaleString("en-IN") || 0}
                            </div>
                            <div className="text-xs text-gray-500">Visitors</div>
                          </div>
                          <div className="text-center">
                            <div className="text-lg font-bold text-gray-900">
                              {userGrowthProgress.summary.mostRecentWeek.newUsers?.toLocaleString("en-IN") || 0}
                            </div>
                            <div className="text-xs text-gray-500">New Users</div>
                          </div>
                          <div className="text-center">
                            <div className="text-lg font-bold text-gray-900">
                              {userGrowthProgress.summary.mostRecentWeek.orders?.toLocaleString("en-IN") || 0}
                            </div>
                            <div className="text-xs text-gray-500">Orders</div>
                          </div>
                        </div>
                        {userGrowthProgress.summary.mostRecentWeek.conversion > 0 && (
                          <div className="pt-3 border-t border-gray-100">
                            <div className="flex justify-between items-center">
                              <span className="text-sm text-gray-600">Week Conversion</span>
                              <span className="text-sm font-semibold text-emerald-600">
                                {userGrowthProgress.summary.mostRecentWeek.conversion.toFixed(2)}%
                              </span>
                            </div>
                          </div>
                        )}
                      ...
                      <div className="text-center py-8">
                        <p className="text-gray-400 text-sm">No recent week data available</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg p-4 border border-amber-100">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <p className="text-xs font-medium text-amber-700">Peak Week Users</p>
                        <p className="text-xl font-bold text-gray-900">
                          {Math.max(...(userGrowthProgress?.datasets?.[0]?.data || [0]))}
                        </p>
                      </div>
                    ...
                    <p className="text-xs text-amber-600">
                      {(() => {
                        const userData = userGrowthProgress?.datasets?.[0]?.data || [];
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 border border-green-100">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <p className="text-xs font-medium text-green-700">Peak Conversion Rate</p>
                        <p className="text-xl font-bold text-gray-900">
                          {Math.max(...(userGrowthProgress?.datasets?.[1]?.data || [0])).toFixed(2)}%
                        </p>
                      </div>
                    ...
                    <p className="text-xs text-green-600">Highest weekly conversion achieved</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-4 border border-blue-100">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <p className="text-xs font-medium text-blue-700">Order per User Ratio</p>
                        <p className="text-xl font-bold text-gray-900">
                          {userGrowthProgress.summary.totalNewUsers > 0
                            ? (userGrowthProgress.summary.totalOrders / userGrowthProgress.summary.totalNewUsers).toFixed(2)
                            : 0}
                        </p>
                      </div>
                    ...
                    <p className="text-xs text-blue-600">Average orders per registered user</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-4 border border-purple-100">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <p className="text-xs font-medium text-purple-700">Weekly Growth Trend</p>
                        <p className={`text-xl font-bold ${userGrowthProgress?.weeklyGrowth > 0 ? 'text-green-600' : 'text-red-600'}`}>
                          {userGrowthProgress?.weeklyGrowth > 0 ? '+' : ''}{userGrowthProgress?.weeklyGrowth || 0}%
                        </p>
                      </div>
                    ...
                    <p className="text-xs text-purple-600">Week-over-week user growth change</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl border border-gray-200 p-5">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="text-sm font-semibold text-gray-900">Conversion Analysis</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Total period performance</p>
                      </div>
                      <div className="text-right">
                        ...
                        <p className="text-xs text-gray-500">
                          {userGrowthProgress.summary.totalOrders || 0} orders / {userGrowthProgress.summary.totalVisitors || 0} visitors
                        </p>
                      </div>
                    </div>
                    <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${Math.min(userGrowthProgress.conversionRate || 0, 100)}%` }}
                      ></div>
                    </div>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        <p className="text-sm font-medium text-gray-900">Visitor to User Conversion</p>
                        <p className="text-xs text-gray-500">Sign-up rate from visitors</p>
                      </div>
                      <div className="text-right">
                        <p className="text-2xl font-bold text-gray-900">
                          {userGrowthProgress.summary.visitorToUserRate?.toFixed(2) || 0}%
                        ...
                        <p className="text-xs text-gray-500">
                          {userGrowthProgress.summary.totalNewUsers || 0} users / {userGrowthProgress.summary.totalVisitors || 0} visitors
                        </p>
                      </div>
                    </div>
                    <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-500">Avg. Weekly Users</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-900">
                        {userGrowthProgress.summary.avgWeeklyVisitors || 0}
                      </div>
                      <div className="text-xs text-gray-500">Avg. Weekly Visitors</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-900">
                        {(userGrowthProgress.summary.avgWeeklyVisitors > 0
                          ? (userGrowthProgress.summary.avgWeeklyUsers / userGrowthProgress.summary.avgWeeklyVisitors * 100).toFixed(1)
                          : 0)}%
                      </div>
                      <div className="text-xs text-gray-500">Weekly Sign-up Rate</div>
                    </div>
                  </div>
                </div>
              </div>
